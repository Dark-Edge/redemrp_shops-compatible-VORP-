...
Config.ShopItemsData = {
{store = "Basic" , label = "Water", item = "water" , price = 0.8 , object = "p_water01x"},
{store = "Basic" , label = "Water", item = "water" , price = 1.0 , object = "p_water01x"},
{store = "Basic" , label = "Water", item = "water" , price = 1.2 , object = "p_water01x"},
{store = "Basic" , label = "Water", item = "water" , price = 1.5 , object = "p_water01x"},
}
